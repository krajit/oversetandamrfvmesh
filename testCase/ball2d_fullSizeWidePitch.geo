ll = 0.01;
a = 0.035;  // ball radius
b = 3*a;  // outer ball radius
N1 = 20;
N2 = 30;
l3 = 15*N1; // number of horizontal split of domain
l4 = 6*N1; // number of vertical split of domain
...
Point(46) = {-10*a, -1, 0, 0.10};
Point(47) = {20, -1, 0, 0.10};
Point(48) = {20, 1, 0, 0.10};
Point(49) = {-10*a, 1, 0, 0.10};
//+
Line(92) = {46, 47};
//+
Line(93) = {47, 48};
...
//+
Plane Surface(109) = {2};
Transfinite Line {94,  92} = 2500;
Transfinite Line {95, 93} = 400;
