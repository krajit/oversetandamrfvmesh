...
#include "dynamicOversetLocalCopyFvMesh.H"
...
namespace Foam
{
    defineTypeNameAndDebug(dynamicOversetLocalCopyFvMesh, 0);
    addToRunTimeSelectionTable(dynamicFvMesh, dynamicOversetLocalCopyFvMesh, IOobject);
}


// * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * * * //

bool Foam::dynamicOversetLocalCopyFvMesh::updateAddressing() const
{
    ...
    if (debug)
    {
        Pout<< "dynamicOversetLocalCopyFvMesh::update() : extended addressing from"
...
Foam::dynamicOversetLocalCopyFvMesh::dynamicOversetLocalCopyFvMesh(const IOobject& io)
:
...
Foam::dynamicOversetLocalCopyFvMesh::~dynamicOversetLocalCopyFvMesh()
{}


// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

const Foam::lduAddressing& Foam::dynamicOversetLocalCopyFvMesh::lduAddr() const
{
    if (!active_)
    {
...
Foam::dynamicOversetLocalCopyFvMesh::primitiveLduAddr() const
{
    if (lduPtr_.empty())
    {
...
bool Foam::dynamicOversetLocalCopyFvMesh::update()
{
...
bool Foam::dynamicOversetLocalCopyFvMesh::writeObject
(
