...
template<class T>
void Foam::dynamicOversetLocalCopyFvMesh::interpolate(Field<T>& psi) const
{
...
void Foam::dynamicOversetLocalCopyFvMesh::interpolate(GeoField& psi) const
{
...
Foam::dynamicOversetLocalCopyFvMesh::scalarInterfaces(const GeoField& psi) const
{
...
template<class Type>
void Foam::dynamicOversetLocalCopyFvMesh::addInterpolation(fvMatrix<Type>& m) const
{
...
template<class Type>
Foam::SolverPerformance<Type> Foam::dynamicOversetLocalCopyFvMesh::solve
(
    fvMatrix<Type>& m,
...
) const
{
    ...
    if (!hasOverset)
    {
        if (debug)
        {
            Pout<< "dynamicOversetLocalCopyFvMesh::solve() :"
...
template<class Type>
void Foam::dynamicOversetLocalCopyFvMesh::write
(
    Ostream& os,
...
template<class GeoField>
void Foam::dynamicOversetLocalCopyFvMesh::correctCoupledBoundaryConditions(GeoField& fld)
{
...
template<class GeoField>
void Foam::dynamicOversetLocalCopyFvMesh::checkCoupledBC(const GeoField& fld)
{
